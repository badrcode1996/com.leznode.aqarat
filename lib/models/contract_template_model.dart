...
class ContractTemplate {
  ...
  static const List<String> _defaultRentClauses = [
    ...
    'دوای تەواو بوونی ماوەی گرێبەستەکە ئەگەر لایەنی دووەم پابەند نەبوو بە چۆڵکردنی موڵکەکە یان نوێکردنەوەی ئەم گرێبەستە ئەوا کرێی موڵکەکە بڕی {late_fee} {currency} دەبێت بۆ هەر ڕۆژێک دواکەوتن.',
