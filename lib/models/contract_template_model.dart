...
class ContractTemplate {
  ...
  static const List<String> _defaultSaleClauses = [
    'ئەم گرێبەستە ڕێکخرا بە مەبەستی فرؤشتنی موڵکی ئاماژە بۆکراوی سەرەوە کە خاوەنداریەکەی دەگەرێتەوە بۆ لایەنی یەکەم بە لایەنی دووەم بە نرخی {total_price} {currency} بۆ ئەم مەبەستەش هەردوو لا ڕەزامەندی تەواوی خۆیان دەربڕی..',
