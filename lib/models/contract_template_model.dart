...
class ContractTemplate {
  ...
  static const List<String> _defaultSaleClauses = [
    ...
    // The schedule starts on its own line. Kept in step with the same clause
    // in functions/contract_defaults.js, which is what actually prints.
    'بڕی پارەی ماوە بەم شێوەی خوارەوە دەدرێت:\n{payment_method}.',
