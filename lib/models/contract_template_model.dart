...
class ContractTemplate {
  ...
  static const List<String> _defaultRentClauses = [
    ...
    'هەردوو لایەن ڕەزامەندن لەسەر کرێی مانگانە بە بڕی {rent_amount} {currency} ({rent_amount_words}).',
    ...
    'دوای تەواو بوونی ماوەی گرێبەستەکە ئەگەر لایەنی دووەم پابەند نەبوو بە چۆڵکردنی موڵکەکە یان نوێکردنەوەی ئەم گرێبەستە ئەوا پابەند دەکرێت بە دانێ بڕی {late_fee} {currency} ({late_fee_words}) بۆ هەر ڕۆژێک دواکەوتن، تاکوو گرێبەستەکە یەکلایی دەبێتەوە.',
  ...
  static const List<String> _defaultSaleClauses = [
    'ئەم گرێبەستە ڕێکخرا بە مەبەستی فرؤشتنی موڵکی ئاماژە بۆکراوی سەرەوە کە خاوەنداریەکەی دەگەرێتەوە بۆ لایەنی یەکەم بە لایەنی دووەم بە نرخی {total_price} {currency} ({total_price_words}) بۆ ئەم مەبەستەش هەردوو لا ڕەزامەندی تەواوی خۆیان دەربڕی..',
    '{company} بڕی {down_payment} {currency} ({down_payment_words}) وەردەگرێت وەکو پێشەکی لە جیاتی لایەنی یەکەم.',
    ...
    'ئەگەر لایەنی یەکەم لە بەرواری دیاریکراودا ئەم موڵکەی ڕادەستی لایەنی دووەم نەکرد ئەوا دەبێت پابەند بێت بە پێدانی بڕی {late_fee} {currency} ({late_fee_words}) بۆ هەر ڕۆژ دواکەوتن.',
    'ئەگەر هاتوو هەر لایەنێک بە هەر هۆیەک پاشەگەزبێتەوە لەم گرێبەستە دەبێت پابەندبێت بە پێدانی بڕی {withdrawal} {currency} ({withdrawal_words}) بۆ لایەنەکەی تر بەبێ ئاگادار کردنەوەی لایەنی فەرمی.',
