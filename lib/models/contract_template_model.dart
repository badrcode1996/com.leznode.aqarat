...
class ContractTemplate {
  ...
  static const List<String> _defaultSaleClauses = [
    'ئەم گرێبەستە ڕێکخرا بە مەبەستی فرؤشتنی موڵکی ئاماژە بۆکراوی سەرەوە کە خاوەنداریەکەی دەگەرێتەوە بۆ لایەنی یەکەم بە لایەنی دووەم بە نرخی {total_price} بۆ ئەم مەبەستەش هەردوو لا ڕەزامەندی تەواوی خۆیان دەربڕی..',
  ...
  static const List<String> _defaultSaleClausesAr = [
    ...
    'يُدفع المبلغ المتبقي وفق الآتي:\n{payment_method}.',
